...
void LabyMainWindow::initConnects()
{
    ...
    connect(this->glModel->playerFieldModel, &Field::cellOpened,
            this->engineManager, &EngineManager::prepareNextStep);
    connect(this->glModel->fieldModel, &Field::cellOpened,
            this->engineManager, &EngineManager::prepareNextStep);
}
//--------------------------------------------------
